...
<div class="container">
    <h1> <s:message code="homepage.category.titlethem"/> </h1>
   ...
   <label for="exampleInputEmail1"> <s:message code="homepage.category.ten"/> * :</label>
    ...
    <f:errors style="color:red" path="ten" element="div"></f:errors>
      <br>
      <button type="submit" class="btn btn-danger"><i class="fa-solid fa-plus"></i>  <s:message code="homepage.category.them"/></button>
