...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <h1 class="giua"> <s:message code="homepage.orderdetail.title"/> #${id }</h1>
     ...
     <c:forEach items="${list }" var="p">
      ...
      <button class="btn btn-info"><a style="color: white;text-decoration: none;" href="${pageContext.request.contextPath }/my-order"><s:message code="homepage.orderdetail.nut"/></a></button>
